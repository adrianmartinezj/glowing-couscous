...
{
    [AddComponentMenu("Event/Tab Input Module")]
    public class S_TabInputModule : PointerInputModule
    {
        ...
        public override bool IsModuleSupported()
        {
            ...
            // to use S_TabInputModule for non-touch input events.
        ...
        protected void ProcessMousePress(MouseButtonEventData data)
        {
            ...
            if (data.PressedThisFrame())
            {
                ...
                // CUSTOM -- This is the part that keeps deselecting items!
